...
INSERT INTO ${this.schema}.cguard_sessions (
  ...
  discord_user_id, discord_link_state, identity_source, session_binding_device_id,
...
VALUES (
  ...
  ${sqlText(record.discord_user_id)}, ${sqlText(record.discord_link_state)},
...
INSERT INTO ${this.schema}.cguard_discord_identity_links (
  user_id, discord_user_id, discord_link_state, identity_source, verification_method,
